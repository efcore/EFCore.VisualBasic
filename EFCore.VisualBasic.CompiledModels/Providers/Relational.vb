Friend Class Relational
    Implements IProvider

    Public ReadOnly Property ForProvider As String Implements IProvider.ForProvider
        Get
            Return "Microsoft.EntityFrameworkCore.Relational"
        End Get
    End Property

    Public Function GetDesignTimeServices(currentAssemblyName As String) As String Implements IProvider.GetDesignTimeServices
        Return Nothing
    End Function

    Public Function GetRuntimeAnnotationCodeGenerator() As String Implements IProvider.GetRuntimeAnnotationCodeGenerator
        Return <![CDATA[Imports EntityFrameworkCore.VisualBasic
