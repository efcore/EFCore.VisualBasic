...
Public Class VisualBasicMigrationsGenerator
    ...
    downOperations As IReadOnlyList(Of MigrationOperation)) As String
        ...
        For Each n In namespaces.Distinct()
        ...
        Using builder.Indent()
            builder.Append("Public Partial Class ").Append(VBCode.Identifier(migrationName))
            Using builder.Indent()
                builder.AppendLine("Inherits Migration")
            End Using
            Using builder.Indent()
    ...
    model As IModel) As String
        ...
        Using builder.Indent()
            builder.Append("<DbContext(GetType(").Append(VBCode.Reference(contextType)).AppendLine("))>") _
            .Append("Partial Class ").Append(VBCode.Identifier(modelSnapshotName))
