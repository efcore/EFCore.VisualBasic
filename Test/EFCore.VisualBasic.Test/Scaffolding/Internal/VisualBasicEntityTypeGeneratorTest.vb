...
"
        ...
        Public Class ModelAnnotationProvider
            ...
            Public Overrides Iterator Function [For](table As ITable) As IEnumerable(Of IAnnotation)
                For Each annotation In MyBase.For(table)
                    Yield annotation
                Next
            ...
            Public Overrides Iterator Function [For](column As IColumn) As IEnumerable(Of IAnnotation)
                For Each annotation In MyBase.For(column)
                    Yield annotation
                Next
