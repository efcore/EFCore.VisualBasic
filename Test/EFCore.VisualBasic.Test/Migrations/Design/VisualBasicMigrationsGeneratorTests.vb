...
",
            ...
            Dim build = New BuildSource With {
                .References = {
                        ...
                        BuildReference.ByName("Bricelam.EntityFrameworkCore.VisualBasic.Test"),
...
Namespace Global.MyNamespace
    ...
    Partial Class MySnapshot
        ...
        Protected Overrides Sub BuildModel(modelBuilder As ModelBuilder)
            ...
            modelBuilder.Entity(""Bricelam.EntityFrameworkCore.VisualBasic.Migrations.Design.VisualBasicMigrationsGeneratorTests+EntityWithConstructorBinding"",
                Sub(b)
                    b.Property(Of Integer)(""Id"").
                        ValueGeneratedOnAdd().
