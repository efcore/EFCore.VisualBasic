    ...
    For Each entityType in Model.GetEntityTypes().Where(Function(e) Not e.IsSimpleManyToManyJoinEntityType())
        ...
        If key IsNot Nothing Then
            ...
            If keyFluentApiCalls IsNot Nothing OrElse
               key.Properties.Count > 1 OrElse
               (Not key.IsHandledByConventions() AndAlso Not Options.UseDataAnnotations)
        ...
        Dim entityTypeFluentApiCalls = entityType.GetFluentApiCalls(annotationCodeGenerator)?.
                                           FilterChain(Function(c) Not (Options.UseDataAnnotations AndAlso c.HasDataAnnotation))
        ...
        For Each index in entityType.GetIndexes().
                                     Where(Function(i) Not (Options.UseDataAnnotations AndAlso i.HasDataAnnotation(annotationCodeGenerator)))
        ...
        For Each prop in entityType.GetProperties()
            Dim propertyFluentApiCalls = prop.GetFluentApiCalls(annotationCodeGenerator)?.
                                              FilterChain(Function(c) Not (Options.UseDataAnnotations AndAlso c.HasDataAnnotation) AndAlso
            ...
            Me.Write(""&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10))
                ...
                For Each skipNavigation In entityType.GetSkipNavigations().Where(Function(n) n.IsLeftNavigation())
                    ...
                    Me.Write(")." & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "                        UsingEntity(Of Dictionary(Of String, Object))(" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "     " &
                            "                       ")
            ...
            Me.Write("            OnModelCreatingPartial(modelBuilder)" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "        End Sub" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "        Part" &
                    "ial Private Sub OnModelCreatingPartial(modelBuilder As ModelBuilder)" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "        En" &
            ...
            If (Me.Errors.HasErrors = False) Then
                ...
                If (ModelValueAcquired = False) Then
                    ...
                    AndAlso tc.CanConvertFrom(GetType(String))) Then
                            ...
                            ModelValueAcquired = True
                        Else
                            Me.Error("The type 'Microsoft.EntityFrameworkCore.Metadata.IModel' of the parameter 'Model'" &
                ...
                If (OptionsValueAcquired = False) Then
                    ...
                    AndAlso tc.CanConvertFrom(GetType(String))) Then
                            ...
                            OptionsValueAcquired = True
                        Else
                            Me.Error("The type 'Microsoft.EntityFrameworkCore.Scaffolding.ModelCodeGenerationOptions' o" &
                ...
                If (NamespaceHintValueAcquired = False) Then
                    ...
                    AndAlso tc.CanConvertFrom(GetType(String))) Then
                            ...
                            NamespaceHintValueAcquired = True
                        Else
                            Me.Error("The type 'System.String' of the parameter 'NamespaceHint' did not match the type " &
