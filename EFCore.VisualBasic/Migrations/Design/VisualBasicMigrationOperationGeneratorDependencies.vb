...
Namespace Migrations.Design
    ''' <summary>
    '''     <para>
    '''         Service dependencies parameter class for <see cref="VisualBasicMigrationOperationGenerator" />
    '''     </para>
    '''     <para>
    ...
    Public Class VisualBasicMigrationOperationGeneratorDependencies
        ...
        ''' <summary>
        '''     <para>
        '''         Creates the service dependencies parameter object for a <see cref="VisualBasicMigrationOperationGenerator" />.
        '''     </para>
        '''     <para>
